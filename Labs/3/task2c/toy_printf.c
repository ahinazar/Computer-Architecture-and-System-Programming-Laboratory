...
struct state_result percent_d_case(state_args *stateArgs, va_list args){
    if (stateArgs->usingArray) {
...
struct state_result percent_b_case(state_args *stateArgs, va_list args){
    if (stateArgs->usingArray) {
        stateArgs->intArray = va_arg(args, int*);
        stateArgs->sizeArray = va_arg(args, int);
...
struct state_result percent_o_case(state_args *stateArgs, va_list args){
    if (stateArgs->usingArray) {
        stateArgs->intArray = va_arg(args, int*);
        stateArgs->sizeArray = va_arg(args, int);
...
struct state_result percent_x_case(state_args *stateArgs, va_list args){
    if (stateArgs->usingArray) {
        stateArgs->intArray = va_arg(args, int*);
        stateArgs->sizeArray = va_arg(args, int);
...
struct state_result percent_X_case(state_args *stateArgs, va_list args){
    ...
    stateArgs->stateResult.new_state=st_printf_init;
    return stateArgs->stateResult;}
struct state_result percent_s_case(state_args *stateArgs, va_list args){
    if (stateArgs->usingArray) {
...
struct state_result percent_c_case(state_args *stateArgs, va_list args){
    if (stateArgs->usingArray) {
...
struct state_result percent_u_case(state_args *stateArgs, va_list args){
    if (stateArgs->usingArray) {
        stateArgs->intArray = va_arg(args, int*);
        stateArgs->sizeArray = va_arg(args, int);
...
struct state_result percent_A_case(state_args *stateArgs, va_list args){
    if (stateArgs->usingArray) {
        toy_printf("Unhandled format %%A%c...\n", *stateArgs->fs);
        exit(-1);
    }
...
struct state_result percent_default_case(state_args *stateArgs, va_list args){
    if (*stateArgs->fs == '-') {
...
struct state_result init_state_handler(va_list args, char* fs, state_args *stateArgs) {
    ...
    struct state_result (*forInit[2])(state_args *) = {init_percent_case,init_default_case};

    struct state_result (*oper[128])(state_args *);
    ...
    int cell = (int) *stateArgs->fs;
    return oper[cell](stateArgs);
}
struct state_result percent_state_handler(va_list args, char* fs, state_args *stateArgs){

    struct state_result (*forInit[11])(state_args*, va_list) = {percent_percent_case,percent_d_case,percent_b_case,percent_o_case,percent_x_case,
                                                              percent_X_case,percent_s_case,percent_c_case,percent_u_case,percent_A_case,percent_default_case};

    struct state_result (*oper[128])(state_args*, va_list);
    ...
    int cell = (int) *stateArgs->fs;
    return oper[cell](stateArgs,args);
}
